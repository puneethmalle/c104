...
cv2.putText(img,n,(960,140),fontFace=cv2.FONT_HERSHEY_COMPLEX,fontScale=0.5,color=(225,225,225))
cv2.putText(img,u,(1120,150),fontFace=cv2.FONT_HERSHEY_COMPLEX,fontScale=0.5,color=(225,225,225))
